...
Write-Host "Function App on Flex Consumption..."
...
Write-Host "Event Grid subscription with filters..."
...
Write-Host "Deploy function code with 'func azure functionapp publish $functionapp' after installing Azure Functions Core Tools."
